...
export class SimulationManager {
    ...
    updateComprehensiveUI() {
        ...
        this.uiManager.updateDistanceAnalytics(this.vehicleManager.vehicles);
        
        // Update SNR analytics
        this.uiManager.updateSNRAnalytics(this.vehicleManager.vehicles);
    ...
    updateUI() {
        if (this.uiManager) {
            ...
            this.uiManager.updateVehicleSummary(this.vehicleManager.getVehicleSummary());
            this.uiManager.updateVehicleStatus(this.vehicleManager.getVehicles());
            this.uiManager.updateDistanceAnalytics(this.vehicleManager.getVehicles());
            this.uiManager.updateSNRAnalytics(this.vehicleManager.getVehicles());
            this.uiManager.updateRLStats(this.networkManager.ai.getStats());
        }
    }
} 