export class UIManager {
    constructor() {
        ...
        // Message type statistics elements
        this.messageTypeStatsElements = {
            SAFETY_MESSAGE: document.querySelector('#safety-message-stats .count'),
            BASIC_CAM_MESSAGE: document.querySelector('#basic-cam-stats .count'),
            TRAFFIC_MESSAGE: document.querySelector('#traffic-message-stats .count'),
            INFOTAINMENT_MESSAGE: document.querySelector('#infotainment-stats .count')
        };
        
        // RL learning statistics elements
