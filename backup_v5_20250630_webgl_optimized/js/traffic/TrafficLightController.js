...
export class TrafficLightController {
    ...
    updateIntersection(intersection, vehicles, currentTime) {
        ...
        if (currentLight.state === 'green') {
            // Check if green time has elapsed or adaptive timing suggests change
            const shouldChangePhase = timeSincePhaseStart >= currentTiming.greenTime ||
                                    (this.adaptiveTimingEnabled && this.shouldChangePhase(intersection));
            ...
            if (timeSincePhaseStart >= currentTiming.greenTime + currentTiming.yellowTime) {
                // Change to red and move to next phase
                ...
                // Wait for all-red time before next phase
                setTimeout(() => {
