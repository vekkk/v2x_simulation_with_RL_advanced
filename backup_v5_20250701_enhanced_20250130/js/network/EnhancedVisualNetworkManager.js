...
export class EnhancedVisualNetworkManager {
    ...
    setPlotManager(plotManager) {
        ...
        console.log('📊 PlotManager set for EnhancedVisualNetworkManager');
    }

    setProcessingManager(processingManager) {
        this.processingManager = processingManager;
        console.log('🖥️ ProcessingManager set for EnhancedVisualNetworkManager');
    }

    setRSUPositions(rsuPositions) {
        this.rsuPositions = rsuPositions || [];
        console.log('📍 RSU positions set:', this.rsuPositions.length, 'positions');
    }

    updateBaseStationPosition(sceneManager) {
        if (sceneManager && sceneManager.baseStationPosition) {
            this.baseStationPosition = sceneManager.baseStationPosition;
            console.log('📍 Base station position updated:', this.baseStationPosition);
        }
    }

    setTrafficCallback(callback) {
        this.trafficCallback = callback;
        console.log('🚦 Traffic callback set for EnhancedVisualNetworkManager');
    }
} 