export const CONFIG = {
    ...
    NETWORK: {
        TYPES: {
            DSRC: {
                latencyMs: 20,
                packetLossRate: 0.05, // Increased from 0.5% to 5% for realistic V2X
                range: 60, // Increased from 50m to 60m
            ...
            WIFI: {
                latencyMs: 50,
                packetLossRate: 0.08, // Increased from 1% to 8% for realistic WiFi
                range: 100, // Increased from 80m to 100m
                color: 0x2196F3, // Blue
                bandwidth: 54, // Mbps
            ...
            LTE: {
                latencyMs: 120,
                packetLossRate: 0.12, // Increased from 2% to 12% for realistic cellular
                range: 250, // Increased from 200m to 250m
                color: 0x9C27B0, // Purple
                bandwidth: 100, // Mbps
                preferredMessages: ['TRAFFIC_MESSAGE', 'INFOTAINMENT_MESSAGE'] // Best for high bandwidth
            }
        },
        MAX_TOTAL_RANGE: 250, // Increased from 200m to 250m
        COMMUNICATION_LINE_DURATION: 500, // ms
        PACKET_SIZE: 512 // Default packet size in bytes
    },
    RSU: {
        NUM_RSUs: 4, // Increased from 2 to 4 for better coverage
